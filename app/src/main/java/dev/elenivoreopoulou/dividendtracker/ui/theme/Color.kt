...
val LightSurfaceSecondary = Color(0xFFEEF1F8)
@Suppress("unused")
val LightSurfaceElevated = Color(0xFFE4E9F3)
...
val LightTextSecondary = Color(0xFF49546E)
val LightTextMuted = Color(0xFF7B849D)

// Semantic
val ErrorRed = Color(0xFFFF7070)
@Suppress("unused")
val WarningYellow = Color(0xFFFBBF24)
@Suppress("unused")
val InfoBlue = Color(0xFF8AA0FF)